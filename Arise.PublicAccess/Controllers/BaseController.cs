...
namespace Arise.PublicAccess.Controllers
{
    ...
    public partial class BaseController : Controller
    {
        ...
        {
            if (RouteData.Values[Constant.PublicAccessApp.Modules.ProviderApplication.RouteID] != null)
            {
                ProviderDomainService.FacilityApplicationID = int.Parse((string)RouteData.Values[Constant.PublicAccessApp.Modules.ProviderApplication.RouteID]);
