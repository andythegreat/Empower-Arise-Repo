...
namespace Arise.PublicAccess.Controllers
{
        ...
        //where TDomainServiceEntity : EntityBase
    {
        ...
        public IViewComponentResult Invoke(Address address, string htmlFieldPrefix)
        {
    ...
    public class AddressUnrequiredViewComponent : ViewComponent
    {
        ...
        public IViewComponentResult Invoke(AddressUnrequired address, string htmlFieldPrefix)
        {
    ...
    public class MarWidgetController : BaseController
    {
        public MarWidgetController(
            GISDomainService gisDomainService,
            ProviderDomainService domainService,
            Empower.Logging.ILogger logger,
        ...
        protected GISDomainService GISDomainService { get; }
